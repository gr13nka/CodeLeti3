...
import kernel32, ExitProcess, 'ExitProcess',VirtualAlloc,'VirtualAlloc',VirtualFree,'VirtualFree',VirtualProtect,'VirtualProtect'
...
Start:
        ...
        invoke VirtualProtect, [Buffer], dword 100, dword PAGE_READONLY, Old
        cmp eax, 0
        je error
